...
| Dosya | Senaryo |
| --- | --- |
| `screenshots/01-normal.png` | Challenge 6 API ayaktayken; üç hedef sağlıklı, Bozuk Hedef ULASILAMIYOR (güncel UI: Operasyon Özeti + SLA + Incident Log) |
| `screenshots/02-alarm.png` | Challenge 6 kapalıyken Mini Envanter kartında ⚠ ALARM + alarm detayı |
| `screenshots/03-yavas.png` | `HEALTH_DELAY_SECONDS=2` ile Mini Envanter kartında 🟡 YAVAS (~2000 ms) |

Görseller 31 Temmuz 2026 itibarıyla güncel dashboard arayüzünden alınmıştır.
